...
public class DataBaseStorageTest {
	...
	public void saveFindTest() {
		...
		// assertEquals("the hashcode must be the same ", value,
		// dao.findByName(obtainer.getParamInfo()).get(0));
	}
	...
	public void deleteTest() {
		...
		// List<ParamValueAbstract<?>> found =
		// dao.findByName(obtainer.getParamInfo());
